...
- This tool can only read text files. To list directories, you must use the `FindFiles` or `ReadDirectory` tools. To read other file types, use appropriate commands via the `Shell` tool.
